        ...
        <div className="w-full md:w-1/4">
          <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 sticky top-24">
            ...
            <nav className="space-y-2">
              ...
              <Link to="/change-password" className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-100 hover:text-black rounded-lg transition-all font-medium">
